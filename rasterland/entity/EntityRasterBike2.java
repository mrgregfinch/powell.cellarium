...
public class EntityRasterBike2 extends Entity
{
    ...
    public EntityRasterBike2(World par1World)
    {
        super(par1World);
    ...
    public EntityRasterBike2(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
...
//        }
        ...
        double d3 = Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ);//distance
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (l = 0; l < list.size(); ++l)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityRasterBike2)
                        {
