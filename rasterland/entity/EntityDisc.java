...
public class EntityDisc extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityDisc(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
     ...
     * 
     * 
     * @param par1World world it is in
     * @param par2EntityLivingBase who threw it
     * @param par3 some sort of velocity multiplier
     */
    public EntityDisc(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
        velocityMultiplier = par3;

        if (par2EntityLivingBase instanceof EntityPlayer)
        {
            this.canBePickedUp = 1;
            System.out.println("Name is " + this.shootingEntity.getEntityName());
        }
...
//        else
        ...
        {
        	if(returnToSender)
        		this.setThrowableHeading(this.shootingEntity.posX, this.shootingEntity.posY, this.shootingEntity.posZ, velocityMultiplier, 1.0F);
            ++this.ticksInAir;
            ...
            System.out.println("In air for " + this.ticksInAir + " ticks");
        }
    }
...
//            }
//
            if (par1EntityPlayer == this.shootingEntity && this.ticksInAir > 2)
            {
