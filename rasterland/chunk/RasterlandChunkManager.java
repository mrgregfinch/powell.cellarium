package powell.rasterland.chunk;
...
import powell.rasterland.world.RasterGenLayer;
...
public class RasterlandChunkManager extends WorldChunkManager
{
	...
	public RasterlandChunkManager(long seed, WorldType terrainType)
	{
		this();
		GenLayer[] agenlayer = RasterGenLayer.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public RasterlandChunkManager(World world)
	{
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) 
	{
		...
		for (int i = 0; i < par4 * par5; ++i) 
		{
			...
			else 
			{
				...
				par1ArrayOfBiomeGenBase[i] = Biomes.green;
			}
		}
