...
import powell.rasterland.block.BlockAwesomeOre;
...
public class RenderAwesomeOre implements ISimpleBlockRenderingHandler
{
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
            ...
            if (modelID == ClientProxy.awesomeOreRenderType) {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
            ...
            ClientProxy.awesomeOreRenderStage = 0;
            ...
            ClientProxy.awesomeOreRenderStage = 1;
            renderer.setRenderBounds(0, 0, 0, 1, 1, 1);
