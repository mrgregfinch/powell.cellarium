...
public class RenderThrownDisc extends Render
{
    private Item field_94151_a;
    private int field_94150_f;

    public RenderThrownDisc(Item par1Item, int par2)
    {
        this.field_94151_a = par1Item;
        this.field_94150_f = par2;
    }

    public RenderThrownDisc(Item par1Item)
    {
        this(par1Item, 0);
    }
    ...
    private void func_77026_a(Tessellator par1Tessellator, Icon par2Icon)
    {
        ...
        GL11.glRotatef(90.0F - this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
