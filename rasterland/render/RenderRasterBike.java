...
public class RenderRasterBike extends Render
{
     ...
     */
    public void renderBoat(EntityRasterBike par1EntityBoat, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
...
//        }
    ...
    protected ResourceLocation getBoatTextures(EntityRasterBike par1EntityBoat)
    {
        return boatTextures;
    }
    ...
    {
        return this.getBoatTextures((EntityRasterBike)par1Entity);
    }
    ...
    {
        this.renderBoat((EntityRasterBike)par1Entity, par2, par4, par6, par8, par9);
    }
}
